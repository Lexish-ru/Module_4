...
def test_vacancy_creation():
    vacancy = Vacancy("Python Developer", "https://example.com", 100000, 150000, "RUR", "CompanyX", "Python, Django", "Backend development")
...
def test_vacancy_salary_none():
    vacancy = Vacancy("QA Engineer", "https://example.com", None, None, None, "CompanyY", "Testing, Selenium", "Automation testing")
